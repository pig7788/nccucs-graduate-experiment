...
def predict_by_t5_based(tensors, encoder_type, src_dataset, tgt_dataset, model_type):
    ...
    for batch_index, batch_inputs in enumerate(tqdm(datasets,
        ...
        decoded_predictions = utility.T5_TOKENIZER.batch_decode(predictions)
        ...
        utility.logging.info('目前已經預測{}筆測試資料'.format(batch_index * BATCH_SIZE))
